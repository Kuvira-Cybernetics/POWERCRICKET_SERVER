...
export class DeckCard extends Schema {
    ...
    @type("number")  level:     number = 1;    // [Type(6)]
}
...
export class BallState extends Schema {
    @type("number")  ballNumber:     number = 0;  // [Type(0)]
    ...
    @type("number")  originalRuns:   number = 0;  // [Type(9)]
}
...
export class InningsData extends Schema {
    ...
    @type("number")    score:           number  = 0;    // [Type(2)]
    @type("number")    wickets:         number  = 0;    // [Type(3)]
    @type("number")    ballsBowled:     number  = 0;    // [Type(4)]
    @type("number")    currentOver:     number  = 0;    // [Type(5)]
    @type("number")    target:          number  = -1;   // [Type(6)] -1 until innings 2
...
export class MatchRoomState extends Schema {
    ...
    @type("number")  oversPerMatch:    number  = 3;     // [Type(5)]
    @type("number")  ballsPerOver:     number  = 6;     // [Type(6)]
    @type("number")  maxWickets:       number  = 10;    // [Type(7)]
